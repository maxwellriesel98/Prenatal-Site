    ...
    case 0:
      ...
      $("#main-body").fadeOut("slow", () => {
        document.getElementById("main-body").innerHTML =
          "Press next to see my content. Press next to see my content. Press next to see my content.  Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content. Press next to see my content.  ";
      });
